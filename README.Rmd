...
R package for the TD Ameritrade API, facilitating authentication, trading, price requests, account balances, positions, order history, option chains, and more. A user will need a TD Brokerage account and TD Ameritrade developer app. Read the [Trade on TD](https://tonytrevisan.github.io/posts/2020-10-17-trade-on-td-ameritrade-with-r/) post for full example of logging in and executing a trade, or see the instructions below.
